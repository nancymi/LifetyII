...
import com.example.nancy.safety.dataBase.bitData;
...
public class GetFoodInfo {
    ...
    public static SQLiteDatabase db;
      ...
      public static void getFoodInfo(Context context) {
          ...
          new Thread() {
              public void run() {
                  URLConnect.URLConnect(infoURL, params);
              }
          }.start();
          while(URLConnect.strResult == null);
          //  System.out.println(URLConnect.URLConnect(infoURL, params));
          msg = URLConnect.strResult;
